...
from modules.utils_fn import copyfile, download_extract
...
def batchify(data):
    ...
    return (reshape(tensor(centers), (-1, 1)), tensor(
        contexts_negatives), tensor(masks), tensor(labels))
...
def offset_inverse(anchors, offset_preds):
    ...
    pred_bbox_wh = exp(offset_preds[:, 2:] / 5) * anc[:, 2:]
    pred_bbox = concat((pred_bbox_xy, pred_bbox_wh), axis=1)
